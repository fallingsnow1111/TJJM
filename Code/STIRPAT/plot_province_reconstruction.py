...
def build_parser() -> argparse.ArgumentParser:
	...
	parser.add_argument(
		"--input-csv",
		default=str(SCRIPT_DIR / "output" / "dataset" / "panel_with_residual.csv"),
		help="Input panel_with_residual CSV path",
	)
	parser.add_argument(
		"--dataset-npz",
		default=str(SCRIPT_DIR / "output" / "dataset" / "stirpat_ee_gru_dataset.npz"),
		help="Dataset NPZ path that stores feature order and standardizer stats",
	)
	parser.add_argument(
		"--model-ckpt",
		default=str(SCRIPT_DIR / "output" / "model" / "best_ee_gru.pt"),
		help="Trained hybrid model checkpoint path",
	)
	parser.add_argument(
		"--output-dir",
		default=str(SCRIPT_DIR / "output" / "visual"),

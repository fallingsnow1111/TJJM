...
# Ensure imports work when running as: python Code/evaluate_reconstruction.py
...
def load_model(cfg: EvalConfig, device: torch.device) -> EntityEmbeddingGRU:
	...
	# Local checkpoint is generated by current project training script and can be trusted.
...
def parse_args() -> EvalConfig:
	...
	parser.add_argument(
		"--output-json",
		type=Path,
		default=base_dir / "Model" / "output" / "reconstruction_metrics.json",
	)
	parser.add_argument(
		"--output-detail-dir",
		type=Path,
		default=base_dir / "Model" / "output",
	)

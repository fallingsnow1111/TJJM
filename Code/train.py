...
# Ensure imports work when running as: python Code/train.py
...
def parse_args() -> TrainConfig:
	...
	default_npz = base_dir / "Dataset" / "output" / "stirpat_ee_gru_dataset.npz"
	default_model = base_dir / "Model" / "output" / "best_ee_gru.pt"
	default_metrics = base_dir / "Model" / "output" / "train_metrics.json"
